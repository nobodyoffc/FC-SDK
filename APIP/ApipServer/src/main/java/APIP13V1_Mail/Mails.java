...
@WebServlet(name = ApiNames.Mails, value = "/"+ApiNames.SN_13+"/"+ApiNames.Version2 +"/"+ApiNames.Mails)
public class Mails extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        FcdslRequestHandler.doSearchRequest(Initiator.sid,IndicesNames.MAIL, Mail.class, null,null,ACTIVE,FALSE,defaultSort, request,response,authType,Initiator.esClient,Initiator.jedisPool);
    }
    @Override
