...
public class ProtocolOpHistory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        FcdslRequestHandler.doSearchRequest(Initiator.sid,IndicesNames.PROTOCOL_HISTORY, ProtocolHistory.class, null,null,OP,RATE, defaultSort,request,response,authType,Initiator.esClient,Initiator.jedisPool);
    }
    @Override
