...
import APIP.apipData.ClientCodeMessage;
...
public class IdentityAPIs {
    ...
    public static ApipClientData fidCidSeekPost(String urlHead, Fcdsl fcdsl, @Nullable String via, byte[] sessionKey) {
        ...
        if (fcdsl.getQuery().getPart() == null) {
            ...
            apipClientData.setCode(ClientCodeMessage.Code9BadQuery);
            apipClientData.setMessage(ClientCodeMessage.Msg9BadQuery);
            return null;
        }
    ...
    public static ApipClientData fidCidGet(String urlHead, String id) {
        ApipClientData apipClientData = new ApipClientData();
