...
public class RequestChecker {
    ...
    private static SignInfo getBodySignInfo(HttpServletRequest request) {
        ...
        if(request.getHeader(SIGN)==null)return new SignInfo(ReplyCodeMessage.Code1000SignMissed, null, 0,0,null,null, null, null, null);
        if(request.getHeader(SESSION_NAME)==null)return new SignInfo(ReplyCodeMessage.Code1002SessionNameMissed, null, 0,0,null,null, null, null, null);
...
//    }
    ...
    public static Object checkOtherRequest(String sid, HttpServletRequest request, AuthType authType, FcReplier replier, Jedis jedis) {
        ...
        if (fcdsl==null || other == null) {
            replier.replyOtherError("The other parameter is missed.", null, jedis);
            return null;
        }
        return other;
    }
