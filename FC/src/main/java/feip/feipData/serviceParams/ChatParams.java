...
public class ChatParams extends Params {
    ...
    public ChatParams(ApipClient apipClient) {
        this.apipClient = apipClient;
    }

    public static ChatParams fromObject(Object data) {
        Gson gson = new Gson();
        return gson.fromJson(gson.toJson(data), ChatParams.class);
    }
    public void setParamsToRedis(String key, Jedis jedis) {
        Map<String, String> paramMap = new HashMap<>();
        for (Field field : ChatParams.class.getDeclaredFields()) {
    ...
    public static ChatParams getParamsFromService(Service service) {
        ChatParams params;
        Gson gson = new Gson();
        try {
            params = gson.fromJson(gson.toJson(service.getParams()), ChatParams.class);
        }catch (Exception e){
