...
public class EccAesDataByte {
    ...
    public static EccAesDataByte fromEccAesData(EccAesData eccAesData) {
        ...
        if (eccAesData.getPassword() != null)
            eccAesDataByte.setPassword(BytesTools.utf8CharArrayToByteArray(eccAesData.getPassword()));
        ...
        if (eccAesData.getPriKeyA() != null)
            eccAesDataByte.setPriKeyA(BytesTools.hexCharArrayToByteArray(eccAesData.getPriKeyA()));
        if (eccAesData.getPriKeyB() != null)
            eccAesDataByte.setPriKeyB(BytesTools.hexCharArrayToByteArray(eccAesData.getPriKeyB()));
        if (eccAesData.getSymKey() != null)
            eccAesDataByte.setSymKey(BytesTools.hexCharArrayToByteArray(eccAesData.getSymKey()));
