...
public class ServiceManager {
    ...
    public void publishService(byte[] symKey,BufferedReader br) {
        ...
        //TODO Create your own service parameters input method. Here is a swap service.
        Object serviceParams = inputSwapParams(symKey, br);
    ...
    @NotNull
    private SwapParams inputSwapParams(byte[] symKey, BufferedReader br) {
        SwapParams serviceParams = new SwapParams();
        serviceParams.inputParams(br, symKey);
