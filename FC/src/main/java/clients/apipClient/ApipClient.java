...
public class ApipClient extends Client {
    ...
    public String broadcastTx(String txHex, HttpRequestMethod httpRequestMethod, AuthType authType){
        Object data = requestByFcdslOther(SN_18, Version2, BroadcastTx, txHex, authType, httpRequestMethod);
        return data==null ? null:(String)data;
    }

    public String decodeTx(String txHex, HttpRequestMethod httpRequestMethod, AuthType authType){
        Object data = requestByFcdslOther(SN_18, Version2, DecodeTx, txHex, authType, httpRequestMethod);
...
//Organize
    ...
    public List<Contact> contacts(Fcdsl fcdsl, HttpRequestMethod httpRequestMethod, AuthType authType){
        Object data = requestJsonByFcdsl(SN_11, Version2, Contacts, fcdsl, authType, sessionKey, httpRequestMethod);
        if(data==null)return null;
    ...
    public List<Secret> secrets(Fcdsl fcdsl, HttpRequestMethod httpRequestMethod, AuthType authType){
        Object data = requestJsonByFcdsl(SN_12, Version2, Secrets, fcdsl, authType, sessionKey, httpRequestMethod);
        if(data==null)return null;
    ...
    public List<Mail> mails(Fcdsl fcdsl, HttpRequestMethod httpRequestMethod, AuthType authType){
        Object data = requestJsonByFcdsl(SN_13, Version2, Mails, fcdsl, authType, sessionKey, httpRequestMethod);
        if(data==null)return null;
    ...
    public String sha256Bytes(String hex,HttpRequestMethod httpRequestMethod, AuthType authType){
        Fcdsl fcdsl = new Fcdsl();
        fcdsl.setOther(hex);
        Object data = requestJsonByFcdsl(SN_17,Version2, Sha256Bytes,fcdsl, authType,sessionKey,httpRequestMethod);
        return (String) data;
    }

    public String sha256x2Bytes(String hex,HttpRequestMethod httpRequestMethod, AuthType authType){
        Fcdsl fcdsl = new Fcdsl();
        fcdsl.setOther(hex);
        Object data = requestJsonByFcdsl(SN_17,Version2, Sha256x2Bytes,fcdsl, authType,sessionKey,httpRequestMethod);
        return (String) data;
    }

    public String ripemd160(String hex,HttpRequestMethod httpRequestMethod, AuthType authType){
        Fcdsl fcdsl = new Fcdsl();
        fcdsl.setOther(hex);
        Object data = requestJsonByFcdsl(SN_17,Version2, Ripemd160,fcdsl, authType,sessionKey,httpRequestMethod);
        return (String) data;
    }

    public String KeccakSha3(String hex,HttpRequestMethod httpRequestMethod, AuthType authType){
        Fcdsl fcdsl = new Fcdsl();
        fcdsl.setOther(hex);
        Object data = requestJsonByFcdsl(SN_17,Version2, KeccakSha3,fcdsl, authType,sessionKey,httpRequestMethod);
        return (String) data;
    }
    ...
    public String checkSum4(String hex,HttpRequestMethod httpRequestMethod, AuthType authType){
        Fcdsl fcdsl = new Fcdsl();
        fcdsl.setOther(hex);
        Object data = requestJsonByFcdsl(SN_17,Version2, CheckSum4,fcdsl, authType,sessionKey,httpRequestMethod);
        return (String) data;
    }
