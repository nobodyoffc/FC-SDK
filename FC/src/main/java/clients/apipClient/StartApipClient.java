...
//        }
    ...
    public static void showExample(byte[] sessionKey, BufferedReader br) {
        ...
        Shower.printUnderline(20);
        System.out.println("Request header:\n" + JsonTools.getNiceString(diskClientData.getRequestHeaderMap()));
        Shower.printUnderline(20);
        System.out.println("Request body:\n" + gson.toJson(diskClientData.getRequestBody()));
        Shower.printUnderline(20);
        System.out.println("Response header:\n" + JsonTools.getNiceString(diskClientData.getResponseHeaderMap()));
        Shower.printUnderline(20);
        System.out.println("Response body:");
        Shower.printUnderline(20);
    ...
    public static void chainInfo() {
        ...
        ApipClientTask diskClientData = BlockchainAPIs.chainInfo(initApiAccount.getApiUrl());
        System.out.println("Result:\n" + diskClientData.getResponseBodyStr());
