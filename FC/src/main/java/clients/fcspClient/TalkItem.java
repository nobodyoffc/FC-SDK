...
public class TalkItem {
    ...
    */
    ...
    private String data;
    private transient byte[] bytes; //roomId+time+nonce+type+content
    public static final String MAPPINGS = "{\"mappings\":{\"properties\":{\"id\":{\"type\":\"keyword\"},\"roomId\":{\"type\":\"keyword\"},\"time\":{\"type\":\"long\",\"format\":\"epoch_millis||strict_date_optional_time\"},\"type\":{\"type\":\"keyword\"},\"content\":{\"type\":\"text\"}}}}";
