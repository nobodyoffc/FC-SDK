...
//        initApiAccount = configure.getInitApipClient().getApiAccount();
        byte[] sessionKey= ApiAccount.decryptSessionKey(initApiAccount.getSession().getSessionKeyCipher(), symKey);
//
//        while (true) {
...
//        }
    ...
    public static void showExample(byte[] sessionKey, BufferedReader br) {
        ...
        fcdsl.addSort("cd", "desc").addSize(2).addAfter(Collections.singletonList("56"));
    ...
    public static byte[] signInEccPost(byte[] symKey, RequestBody.SignInMode mode) {
        ...
        ApiAccount.writeApipParamsToFile(initApiAccount, Constants.APIP_Account_JSON);
