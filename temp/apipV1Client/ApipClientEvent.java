...
//    public ApipClientEvent(String urlHead, String type, String sn, String version, String apiName) {
//        super(urlHead,type, sn, version, apiName);
//    }
//    public ApipClientEvent(String urlHead, String type, String sn, String ver, String apiName, Map<String,String>paramMap) {
//        super( urlHead, type, sn, ver, apiName, paramMap);
//    }
//    public ApipClientEvent(byte[] authKey, String urlHead, String type, String sn, String ver, String apiName, String via, AuthType authType, Map<String,String>paramMap) {
